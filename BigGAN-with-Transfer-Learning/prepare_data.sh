...
#ATENCION!!!!! SI SE HACE UN NUEVO DATASET, HAY QUE MOVER/ELIMINAR LOS ARCHIVOS DE MineGAN/MineGANmaster:
 ...
 # Parémetro --chunk_size >= num. imágenes
...
python make_hdf5.py --dataset I128 --batch_size 256 --data_root /home/javier/TFM/MineGAN/MineGANmaster/datasets/100_obama --chunk_size 100
python calculate_inception_moments.py --dataset I128_hdf5 --data_root /home/javier/TFM/MineGAN/MineGANmaster/datasets/100_obama