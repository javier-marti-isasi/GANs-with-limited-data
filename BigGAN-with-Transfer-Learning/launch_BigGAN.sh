...
python train.py \
--dataset I128_hdf5 --shuffle --num_workers 2 --batch_size 24 --resume \
...
--which_best FID \
--G_ch 96 --D_ch 96 \
--test_every 27 --save_every 13 --num_best_copies 5 --num_save_copies 2 --seed 0 \
--use_multiepoch_sampler \
--base_root /content/drive/MyDrive/MASTER/TFM/Repositorios/MineGAN/data/your_data \
