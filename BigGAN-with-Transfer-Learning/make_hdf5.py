...
def run(config):
  ...
  #Error pasado: Chunk shape must not be greater than data shape in any dimension. (500, 3, 128, 128) is not compatible with (128, 3, 128, 128)
