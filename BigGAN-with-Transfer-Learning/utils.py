...
def get_data_loaders(dataset, data_root=None, mirror_augment=False, batch_size=64,
  ...
  if 'hdf5' in dataset:
    ...
    # Javier: aumentar aunque sea hdf5
    if mirror_augment:
      print('Data (hdf5) will be augmented...')
...
def load_weights(G, D, M, state_dict, weights_root, experiment_name, 
  ...
  #root = '/media/javier/56102013101FF8A7/MineGAN/MineGANmaster/data/your_data/weights'
  if name_suffix:
