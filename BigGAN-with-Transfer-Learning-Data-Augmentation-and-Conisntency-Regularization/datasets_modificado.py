...
def find_classes(dir):
  print("Imprimir classes")
  print("dir: " + dir)
  print("os.listdir(dir): ")
  print(os.listdir(dir))
  print([d for d in os.listdir(dir) if os.path.isdir(os.path.join(dir, d))])
...
class ImageFolder(data.Dataset):
  ...
  def __init__(self, root, transform=None, target_transform=None,
    ...
    if os.path.exists(index_filename):
      ...
      print(os.path.exists(index_filename))
      print('Loading pre-saved Index file %s...' % index_filename)
      imgs = np.load(index_filename)['imgs']
      print("imgs:")
      print(np.load(index_filename))
...
class ILSVRC_HDF5(data.Dataset):
  def __init__(self, root, transform=None, target_transform=None,
    ...
    self.root = root
    #self.root = "/media/javier/56102013101FF8A7/MineGAN/MineGANmaster/data/arch/ILSVRC128.hdf5"
    #root = "/media/javier/56102013101FF8A7/MineGAN/MineGANmaster/data/arch/ILSVRC128.hdf5"
    #########
